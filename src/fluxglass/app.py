...
class ResourceWindow(Gtk.ApplicationWindow):
    ...
    def build(self):
        ...
        view=Gtk.MenuButton(label=t("view")); popover=Gtk.Popover(); choices=Gtk.Box(orientation=Gtk.Orientation.VERTICAL,spacing=8)
        ...
        popover.set_child(choices); view.set_popover(popover); head.append(view)
